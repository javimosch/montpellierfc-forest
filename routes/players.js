...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('players');

// This file contains the logic of every route in Forest Admin for the collection players:
...
// Create a Player
router.post('/players', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Player
router.put('/players/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Player
router.delete('/players/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/players', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/players/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Player
router.get('/players/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/players.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
