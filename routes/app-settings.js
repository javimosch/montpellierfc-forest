...
const { app_settings } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('app_settings');

// This file contains the logic of every route in Forest Admin for the collection app_settings:
...
// Create a App Setting
router.post('/app_settings', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a App Setting
router.put('/app_settings/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/app_settings/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/app_settings', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of App Settings
router.get('/app_settings/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a App Setting
router.get('/app_settings/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of App Settings
router.get('/app_settings.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
